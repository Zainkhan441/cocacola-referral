...
// day-aware reset via isNewPakistanDay" idiom already used by
...
//   1. Start — created (or reset, if completedAt is from an earlier Pakistan
...
//      Pakistan day per task; the SAME transaction that sets completedAt also
